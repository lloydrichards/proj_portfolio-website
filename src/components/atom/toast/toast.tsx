...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "text-foreground/50 hover:text-foreground group-[.destructive]:text-destructive-foreground hover:group-[.destructive]:text-destructive-foreground/80 focus:group-[.destructive]:ring-destructive focus:group-[.destructive]:ring-offset-destructive absolute top-2 right-2 rounded-md p-1 opacity-0 transition-opacity group-hover:opacity-100 focus:opacity-100 focus:ring-2 focus:outline-hidden",
      className,
    )}
    toast-close=""
    {...props}
