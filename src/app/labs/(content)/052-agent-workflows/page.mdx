...
solving the same challenge: generate data visualizations using web components.
Each architecture taught me something different about the trade-offs involved.
...
2. **The Vega** - Minimal architecture using simplified JSON specs
...
3. **Caching for cost-efficiency.** The Oracle's first call was expensive, but
