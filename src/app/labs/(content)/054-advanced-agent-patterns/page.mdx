...
Building on the simple agentic workflows from the
[previous article](/labs/052-agent-workflows), I wanted to explore more advanced
patterns that could improve the quality and reliability of agent outputs. These
patterns trade additional LLM calls for better results through parallel analysis
              ...
              iteration === 1 || !previousEvaluation
                ...
                : String.stripMargin(`
                    ...
                    |${memory
                      .map(
                        (m, i) =>
                          `Attempt ${i + 1} (Score: ${m.evaluation.score}): ${
