...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      typefaceMeta("flex flex-col space-y-1.5 px-3 pt-1 pb-1"),
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center px-3 pt-0 pb-1", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("absolute top-4 right-3", className)}
    {...props}
  />
));
