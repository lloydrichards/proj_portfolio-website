...
const tileVariants = cva("bg-card relative overflow-hidden rounded-md", {
  variants: {
    size: {
      ...
      "square-sm":
        "col-span-8 row-span-3 md:col-span-3 md:row-span-3 lg:col-span-5 lg:row-span-5",
      "square-md":
        "col-span-8 row-span-4 md:col-span-4 md:row-span-4 lg:col-span-6 lg:row-span-6",
    },
    outline: {
      true: "border",
      false: "",
