...
export const occupationData: Array<Occupation> = [
  ...
  },
  {
    ...
    location: "Switzerland",
    description:
      "Building digital products and design data structures for improving existing databases.  Build the companies first design system to create cohersion across platforms.  Worked with a web and app developer to bring design into production.",
    skills: [
      "Web Design(Figma)",
      "Frontend(Typescript, React)",
