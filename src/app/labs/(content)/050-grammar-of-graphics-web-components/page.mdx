...
Recently I've been exploring a new idea:

> What if we could build data visualizations using HTML as the composition
...
- **Layer 1: Data Management** - Handle data loading, parsing, and
  transformation
- **Layer 2: Visualization Container** - Orchestrate rendering and manage scales
- **Layer 3: Visual Elements** - Render the actual chart marks, axes, and
  legends
