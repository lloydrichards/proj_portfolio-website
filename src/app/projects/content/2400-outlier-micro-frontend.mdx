...
date: 2024-06-12
description:
  Localized schedule builder using micro-frontend architecture. Next.js frontend
  with modular deployment. Backend powered by Supabase + PostgreSQL.
isFeatured: true
category:
  - DEVELOP
  - DESIGN
image: /images/projects/2400/thumb_outlier-micro-frontend.webp
