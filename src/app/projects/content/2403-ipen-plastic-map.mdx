...
date: 2024-11-01
description:
  Interactive map of global plastic pollution data for IPEN. Built fullstack app
  using Next.js, PostgreSQL, and D3. Designed map interactivity and backend
  filters for dynamic loading.
isFeatured: true
category:
  - DEVELOP
image: /images/projects/2403/thumb_ipen-plastic-map.webp
href: https://ipen-plastic-map.vercel.app/
team: [["Annabelle Vuille", "Designer"], ["Lloyd Richards", "Developer"]]
---
