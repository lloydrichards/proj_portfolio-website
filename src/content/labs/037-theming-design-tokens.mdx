...
date: 2024-02-17
description:
  Learn how to use design tokens to create Tailwind themes and how to use them
  for my website.
tags:
  - design tokens
  - tailwind
...
website that can be easily switched between. This works for both light and
dark themes and can be easily extended to create more themes.
