...
date: 2024-10-01
description:
  Data exploration dashboard using React and D3 to visualize cancer trends in
  Switzerland. Implemented filtering logic, tooltips, and accessible UX
  patterns.
isFeatured: true
category:
  - DEVELOP
image: /images/projects/2402/thumb_cancer-monitoring-dashboard.webp
href: https://krebs-monitoring.bfs.admin.ch/de/
team:
  [
    ["Florencia Kühne", "Project Manager"],
    ["Michael Schönenberger", "Designer"],
    ["Bartosz Prusinowski", "Developer"],
    ["Nastasja Steinhauer", "Intern"],
    ["Lloyd Richards", "Developer"],
  ]
awards:
  - award: "German Design Awards 2026"
