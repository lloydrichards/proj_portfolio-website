...
/**
 * Shared prose component mappings used by both the MDX pipeline and
 * the runtime `<Markdown>` renderer. Keep server-only components
 * (Mermaid, GitHubCommitCard) out of this file.
 */
