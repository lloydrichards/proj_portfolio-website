...
the team developing the Cancer Monitoring Dashboard, which visualises
statistical data on cancer incidence, mortality, and survival. This project
showcases our expertise in creating user-friendly data visualisation tools while
addressing unique challenges in public health communication.
...
Charts, Table Charts, and Layout + Theming. To make the charts accessible and
easy to navigate, they were built using a combination of semantic HTML tables
and SVG built using D3.js. However, this approach presented challenges regarding
flexible height and state management.

A significant achievement was expanding our `swiss-federal-ci` library, which is
now a shared component library across multiple projects. This effort to
